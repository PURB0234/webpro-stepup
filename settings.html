        ...
        <div class="sidebar-content">
          <nav>
            <ul>
              ...
              <li>
                <a href="#" class="sidebar-link" style="background-color: #eee">
        ...
        <main class="main">
          <div class="main-content">
            <section class="settings">
              ...
              <p class="card-text">
                Manage your profile, notification preferences, and application
                settings.
              </p>
              ...
              <div class="card">
                ...
                <div class="profile-info">
                  <img src="assets/avatar/1.jpg" alt="Profile" />
                  <div class="info-form">
                    <label>Full Name</label>
                    <input type="text" value="Evan Patrick" />

                    <label>Email</label>
                    <input type="email" value="evan.patrick@student.edu" />

                    <label>Major</label>
                    <input type="text" value="Computer Science" />

                    <label>Student ID</label>
                    <input type="text" value="CS10203" />
                  </div>
                </div>

                <label>Bio</label>
                <textarea rows="3">
Fourth-year Computer Science student passionate about solving practical problems using software engineering.</textarea
                >
              ...
              <div class="card">
                ...
                <p>Control how you receive updates and announcements.</p>

                <div class="notif-section">
                  <h3>Email Notifications</h3>
                  <label
                    ><input type="checkbox" checked /> Course
                    Announcements</label
                  >
                  <label
                ...
                <div class="notif-section">
                  ...
                  <label><input type="checkbox" /> Group Activity</label>
                </div>
              ...
              <div class="card">
                ...
                <div class="setting-section">
                  <h3>Display</h3>
                  <p>App Theme</p>
                  <small>Choose between light or dark mode.</small>

                  <div class="radio-group">
                    <label
                      ><input type="radio" name="theme" checked /> Light</label
                    >
                ...
                <div class="setting-section">
                  ...
                  <p>Language</p>
                  <small
                    >Select your preferred language for the application.</small
                  >
                  <select>
                ...
                <div class="setting-section">
                  ...
                  <p>Data Usage</p>
                  <small
                    >Current application data storage on your device.</small
                  >

                  <div class="storage">
                    <input type="text" value="255 MB" readonly />
              ...
              <div class="card">
                ...
                <button class="faq">Visit FAQ</button>
